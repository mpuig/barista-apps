...
- [x] Add a packaged `barista-managed-smoke` command with bounded JSON output.
- [x] Add a fast managed lifecycle continuity acceptance case.
- [x] Run the dependency-gated managed Factory case from the default profile.
- [x] Fail the operator gate when any selected pytest case skips.
...
- [x] Run the model gate after immutable Claude, Pi, and Codex images are published and installed with provider-side secret references.
