...
- [x] Add distinct presenter-token configuration and safe provisioning.
- [x] Add durable idempotent scenario launch and terminal-only reset.
- [x] Add bounded presenter state with attempts, dependencies, artifacts, deployment, and next action.
