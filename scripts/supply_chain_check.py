...
def check_sdk_contract_copies() -> None:
    copies = {
        ...
        "apps/change-agent/barista_app_change_agent/manifest.json":
            "apps/change-agent/manifest.json",
        "apps/factory/barista_app_factory/manifest.json":
            "apps/factory/manifest.json",
    }
